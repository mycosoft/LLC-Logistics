                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="charge_type" id="charge_type" class="form-control">
                                ...
                                <option value="per_cbm" {{ old('charge_type', $shipment->charge_type) == 'per_cbm' ? 'selected' : '' }}>Per CBM</option>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.001" name="cbm" id="cbm" class="form-control" value="{{ old('cbm', $shipment->cbm) }}" placeholder="0.000">

...
@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1>Sea Cargo Details: {{ $shipment->tracking_number }}</h1>
        </div>
        <div class="col-sm-6">
            <div class="float-right">
                <a href="{{ route('admin.sea-cargo.edit', $shipment) }}" class="btn btn-warning">
                    <i class="fas fa-edit"></i> Edit
                </a>
                <a href="{{ route('admin.sea-cargo.index') }}" class="btn btn-default">
